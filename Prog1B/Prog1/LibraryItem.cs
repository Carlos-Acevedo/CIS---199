...
namespace LibraryItems
{
    public abstract class LibraryItem : IComparable<LibraryItem>
    {
        ...
        // Precondition:  None
        // Postcondition: When this < other, method returns negative #
        //                When this == other, method returns zero
        //                When this > other, method returns positive #
        public int CompareTo(LibraryItem other)
        {
            if (other == null)
                return 1;

            if (Title.CompareTo(other.Title) != 0)                      // Different Title?
                return Title.CompareTo(other.Title);                    // Use Title to decide
            //else if (Publisher.CompareTo(other.Publisher) != 0)         // Differnet Publisher?
            //    return Publisher.CompareTo(other.Publisher);            // Use Publisher to decide
            //else if (CopyrightYear.CompareTo(other.CopyrightYear) != 0) // Different CopyrightYear?
            //    return CopyrightYear.CompareTo(other.CopyrightYear);    // Use CopyrightYear to decide
            //else if (LoanPeriod.CompareTo(other.LoanPeriod) != 0)       // Differnt LoanPeriod?
            //    return LoanPeriod.CompareTo(other.LoanPeriod);          // Use LoanPeriod to decide
            //else                                                        // Down to CallNumber    
            //    return CallNumber.CompareTo(other.CallNumber);          // Use CallNumber to decide    
            else
                return 0;                       //Narural order
        }
    }
}
