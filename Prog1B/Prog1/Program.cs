...
// File: Program.cs
// This file compares titles in asending order and copyright year in decending order
...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        foreach (LibraryItem item in items) // Display the original list
            Console.WriteLine($"{item}\n");
        Pause();

        items.Sort(); // Sort - uses natural order
        Console.WriteLine("List of items by Title:\n");
        foreach (LibraryItem item in items)
            Console.WriteLine($"{item}\n");
        Pause();

        items.Sort(new DescendingOrderCopyright()); // Sort - uses specified Comparer class
        Console.WriteLine("List of items by copyright year in decending order:\n");
        foreach (LibraryItem item in items)
            Console.WriteLine($"{item}\n");
        Pause();
    }
